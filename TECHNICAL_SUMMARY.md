...
- **`Lead`**: Captures user interest from the landing page. Stores preferred pace and specific book interest.
...
- **Type-Safety**: Uses Pydantic schemas (`LeadIn`, `LeadOut`) for strict request/response validation.
